...
// Adapted from https://rosettacode.org/wiki/Burrows%E2%80%93Wheeler_transform#Java
...
public class BurrowsWheelerTransform {
    ...
    public static String compress(String input) {
        String transformedInput = bwt(input);
        return RunLengthEncoding.compress(transformedInput);
    }

    public static String decompress(String input) {
        String decompressed = RunLengthEncoding.decompress(input);
        String detransformed = ibwt(decompressed);
        return makePrintable(detransformed);
    }
