...
// Implementation adapted from https://github.com/mukeshkdangi/image_compression
...
public class DiscreteCosineTransform {
    ...
    public static void main(String[] args) {
        DiscreteCosineTransform ren = new DiscreteCosineTransform();
    ...
    public void prcocessDCTDWTTransformation(String filepath, String coefficient) {

        try {
            File file = new File(filepath);
            int coefficientNum = Integer.parseInt(coefficient);
